...
The full answer is complex and completely and beyond the scope of a 7-minute chapter, but the biggest issue boils down to two simple questions:

1. Do you have a sound set of exegetical rules?
2. Do you follow them?

Having good rules—and sticking to them even when they cut against your theological dispositions—is critical.

In this chapter, I’m going to lay out the rules I use—and make the case, as best I can, for why they matter.


## RIGHT: Rules for Interpreting God’s Holy Text

One of the best defenses against drifting into error is to employ sound exegetical rules. Applied correctly, rules become tools that keep us from reading our own ideas into Scripture and then mistaking those ideas for revelation.

While there are many rules one might reasonably apply, two are absolutely essential. I call this two‑rule system **RIGHT**—short for **R**ules for **I**nterpreting **G**od’s **H**oly **T**ext.


## RIGHT‑1: You must define biblical words and expressions using their *biblical* definitions.
...
The **BYOD Test** is simply an extension of **RIGHT‑1**. Take a verse, replace the key words with the definitions used by different traditions, and see what happens.

Very often, you will see that the correct interpretation becomes obvious. One reading will fit naturally; the other will look like someone trying to shove the square pegs of their theology through the round holes of Scripture.

What I love about the **BYOD Test** is how wonderfully unbiased it is. 

The best Christian apologists in the business are generally one part devoted believer and one part used-car salesman. Let them talk long enough and they’ll make any clunker sound like a take-my-money limited‑edition classic.

But the **BYOD Test** cuts through all of that. It doesn’t care how polished the argument is, how passionate the speaker is, or how many footnotes they bring to the fight. It simply asks:

**Does your definition actually work in the verse?**

If it doesn’t, no amount of rhetorical wax and polish will make it run.



### RIGHT‑2: Any interpretation of a verse that does not agree with the *context* is wrong.

Context is king. If your interpretation doesn’t sit well in the context, it’s time to get a new interpretation.

Take a verse out of context, and you can make the Bible say anything:

- Angry at your parents?—*There’s a verse for that.* (Luke 14:26)  
- Want to revive corporal punishment?—*There’s a verse for that.* (Proverbs 13:24)  
- Need biblical justification for insulting someone?—*There’s a verse for that.* (Matthew 7:6)  
- Interested in self‑mutilation?—*There’s a verse for that.* (Matthew 5:29)  
...
### RIGHT‑0: The Rule to Rule All Rules

I know I said there were only two **RIGHT** rules. And I meant that. However, the two **RIGHT** rules I presented often dovetail into a single **super‑rule**. That happens when the definition of a key word or expression is actually included in the immediate context. 

When this occurs, I refer to it as **RIGHT‑0**.
