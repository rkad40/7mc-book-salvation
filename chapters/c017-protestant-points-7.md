...
Romans 4:4–5 looks tailor‑made for Protestant theology and seems eager to play the part.
...
To answer that, we only need to answer a related question:
...
- **Person 1**: “the one who *works*” = the circumcised Jew relying on Mosaic works (e.g., circumcision), believing justification is his “due.”  
...
Romans 4 overwhelmingly supports this reading. Here are five reasons why.

### Reason 1: Romans 4:4–5 Is Part of the Abraham Timeline Argument

Romans 4:4–5 does not float freely; it is anchored in [The Abraham Timeline Argument](./c010-the-abraham-timeline-argument.md). I won’t rehash that argument in detail here. But I will outline the basic points. 
...
Protestants claim Paul is teaching justification by faith alone apart from *works*. But if that were true, Paul’s argument collapses:
...
Conversely, under the Christian system (**Person 2**), salvation is a **gift** received **by faith**—later described as an **inheritance**, something given rather than earned.
...
Throughout Romans Paul contrasts the same two groups:
...
those who have the **LAW**      | those who do not have the **LAW**  
those who have the written code | those who have the precepts of the **LAW** written on the heart  

Romans 4:4–5 simply adds another pairing:
...
But everyone engages in human effort. To fix this, Protestants must qualify “works” in Romans 4:
...
Look what happens when we do the reverse and take the Protestant definition of “works” from Romans 4:4-5 and inject it into Romans 3:28:

> For we hold that a man is justified by faith apart from *any human effort with the intent of earning salvation*.
