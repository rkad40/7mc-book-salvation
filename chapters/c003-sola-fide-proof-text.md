...
This distinctly Protestant idea is known in academic circles as the **Perspicuity of Scripture**.

The word *perspicuity* simply means “clarity,” and the doctrine asserts exactly that.

Oftentimes, Protestant theologians appeal to the “plain sense” or “clear meaning” of Scripture—a layman’s shorthand for this doctrine. One Protestant commentator summarizes it this way:
...
Dr. R. C. Sproul echoes the same sentiment in *Essential Truths of the Christian Faith*:
...
We will examine James 2:24 in a later chapter. For now, it is enough to note that this is not a verse Protestants place in the “perspicuous” column.
...
At first glance, the logic seems straightforward. Paul contrasts **faith** with **works**. Justification comes through the former, not the latter. Thus, according to the Protestant position, Paul’s answer to the question “What must I do to be saved?” is simple: *have faith*.
...
But the adjective “good” is irrelevant. No one argues that a person might be justified by **evil** works. Whether good or evil, **all works must be excluded**. Thus:
...
While the word “alone” does not appear in Paul’s version of Romans 3:28, it has certainly made itself at home in Protestant theology.
...
Catholics have long viewed the Protestant move from “apart from works of the law” to “faith alone” as a misreading of the text.
